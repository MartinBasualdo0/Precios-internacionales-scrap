...
```{r}
#boton_siguiente <- driver$findElement(using = 'css', value = '.board-table-pag-content__table')
boton_siguiente <- driver$findElement(using = 'css', value = '.next')
for (i in 1:1000){
  
  boton_siguiente$clickElement()
}
```
